...
//       prepareProductQuantityData(response.data);
//     } catch (error) {
//       handleError(error);
//     }
//   };
...
//     try {
//       const response = await axios.get(
//         `${baseUrl}${apiEndPoint.orderHistoryAll}?adminId=${adminDetails.adminId}&date=${selectedDate}`,
//         {
//           headers: {
//             Authorization: "Bearer " + adminDetails?.jwtToken,
//           },
...
//           }}
//         >
//           <Typography variant="h5">Quantity Sold Per Product Today</Typography>
...
//           }}
//         >
//           <Typography variant="h5">Quantity Distribution by Product</Typography>
//           {productQuantityData.labels.length > 0 && (
//             <Doughnut data={productQuantityData} />
//           )}
//         </Grid>

//         <Grid item md={6} sm={12} className="recent-sales">
//           <TableContainer
//             component={Paper}
//             style={{ maxHeight: 390, overflow: "auto", margin: "10px auto" }}
//           >
//             <Table stickyHeader>
