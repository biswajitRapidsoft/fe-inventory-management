    ...
    <div className="inventory">
      <Grid container>
        <Grid item container xs={12}>
          <Grid item xs={12} sm={6} className="search-addbtn">
            <div className="product-search">
              ...
              />
              <Button className="search-btn" type="submit" variant="contained">
                Search
              </Button>
            </div>
          </Grid>
          ...
          <Grid
            ...
            gap={1}
          >
            <Grid item xs={6} sm={4} className="inventory-filter">
              <FormControl
